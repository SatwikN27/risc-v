...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-956279-gelib-4e-37.ews.illinois.edu/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -sv -include /software/xilinx-2025.1/2025.1/Vivado/data/rsb/busdef /software/xilinx-2025.1/2025.1/Vivado/data/ip/xpm/xpm_memory/hdl/xpm_memory.sv
      rt::read_verilog -sv -include /software/xilinx-2025.1/2025.1/Vivado/data/rsb/busdef {
      ...
      rt::read_verilog -include /software/xilinx-2025.1/2025.1/Vivado/data/rsb/busdef {
      ./.Xil/Vivado-956279-gelib-4e-37.ews.illinois.edu/realtime/blk_mem_gen_1_stub.v
      ./.Xil/Vivado-956279-gelib-4e-37.ews.illinois.edu/realtime/blk_mem_gen_0_stub.v
    }
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-956279-gelib-4e-37.ews.illinois.edu/"
