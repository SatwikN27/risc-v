...
#
# Script generated by Vivado on Wed Mar 04 22:36:47 CST 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../software/xilinx-2025.1/2025.1/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_11 $vlogan_opts +v2k +incdir+"../../../../../../../../../software/xilinx-2025.1/2025.1/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../software/xilinx-2025.1/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/rohankr2/projects/risc-v/risc-v/risc-v.cache/compile_simlib/vcs"
  fi
